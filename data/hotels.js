window.HOTEL_DATA = {
  ...
  9: {
    optionA: {
      ...
      stars: 3,
      bookingUrl: "https://www.booking.com/hotel/us/hampton-inn-suites-windsor-sonoma-wine-country.html?checkin=2026-05-31&checkout=2026-06-02&group_adults=2&group_children=3&no_rooms=1&age=10&age=8&age=5",
      pricePerNight: "$145",
  ...
  15: {
    optionA: {
      name: "Pacific Sunset Inn — Brookings",
      stars: 3,
      bookingUrl: "https://www.booking.com/hotel/us/brookings-1144-chetco-avenue.html?checkin=2026-06-06&checkout=2026-06-07&group_adults=2&group_children=3&no_rooms=1&age=10&age=8&age=5",
      pricePerNight: "$250",
      priceNote: "Booking.com verified for Jun 6 2026 (2 adults + 3 kids). Note: 'Holiday Inn Express Brookings' does not exist — replaced with Pacific Sunset Inn.",
      roomConfig: "Standard rooms with 2 Queens for family of 5. Request largest room configuration.",
      freeBreakfast: false,
      separateRoom: false,
      pool: false,
      reason: "Well-reviewed inn in Brookings at the start of the Oregon Coast stretch. No Holiday Inn Express exists in Brookings — this is the best mid-range option in town."
    },
    optionB: {
      name: "Ocean Suites Motel — Brookings",
      stars: 3,
      bookingUrl: "https://www.booking.com/hotel/us/ocean-suites-motel.html?checkin=2026-06-06&checkout=2026-06-07&group_adults=2&group_children=3&no_rooms=1&age=10&age=8&age=5",
      pricePerNight: "$314",
      priceNote: "Booking.com verified for Jun 6 2026 (2 adults + 3 kids). Rated 9.5/10 'Exceptional'.",
  ...
  16: {
    optionA: {
      ...
      stars: 3,
      bookingUrl: "https://www.booking.com/hotel/us/hampton-inn-medford.html?checkin=2026-06-07&checkout=2026-06-08&group_adults=2&group_children=3&no_rooms=1&age=10&age=8&age=5",
      pricePerNight: "$165",
      priceNote: "Booking.com verified for Jun 7 2026 (2 adults + 3 kids)",
    ...
    optionB: {
      ...
      pricePerNight: "$199",
      priceNote: "Booking.com verified for Jun 7 2026 (2 adults + 3 kids). Shakespeare Festival season rates.",
  ...
  19: {
    optionA: {
      ...
      stars: 4,
      bookingUrl: "https://www.booking.com/hotel/us/royal-sonesta-portland.html?checkin=2026-06-10&checkout=2026-06-11&group_adults=2&group_children=3&no_rooms=1&age=10&age=8&age=5",
      pricePerNight: "$110",
    ...
    optionB: {
      ...
      pricePerNight: "$250",
      priceNote: "Estimated; not found on Booking.com for this date. Verify at Hilton.com for June 2026.",
